...
public class LinterTest {
    ...
    public void testLinter() {
        ...
        Assert.assertEquals("Line 3: Missing semicolon.\n" +
                ...
                "Line 101: Missing semicolon.", returnString);
    }

    @Test
    public void testLinterNoErrors() {
        String returnString = Linter.linter("src/main/resources/noErrors.js");
        System.out.println(returnString);
    ...
    public void testLinterOneError() {
        String returnString = Linter.linter("src/main/resources/oneError.js");
        System.out.println(returnString);
        Assert.assertEquals("Line 5: Missing semicolon.", returnString);
    }

    @Test
    public void testLinterFewErrors() {
        String returnString = Linter.linter("src/main/resources/fewErrors.js");
        System.out.println(returnString);
        Assert.assertEquals("Line 3: Missing semicolon.\n" +
                "Line 5: Missing semicolon.\n" +
                "Line 11: Missing semicolon.\n" +
                "Line 13: Missing semicolon.\n" +
                "Line 15: Missing semicolon.", returnString);
    }

    @Test
    public void testLinterManyErrors() {
        String returnString = Linter.linter("src/main/resources/manyErrors.js");
        System.out.println(returnString);
        Assert.assertEquals("Line 3: Missing semicolon.\n" +
                "Line 5: Missing semicolon.\n" +
                "Line 11: Missing semicolon.\n" +
                ...
                "Line 15: Missing semicolon.\n" +
                "Line 26: Missing semicolon.\n" +
                "Line 28: Missing semicolon.", returnString);
    }

    @Test
    public void testLinterEmptyFile() {
        String returnString = Linter.linter("src/main/resources/emptyFile.js");
        System.out.println(returnString);
        Assert.assertEquals("", returnString);
    }
}
